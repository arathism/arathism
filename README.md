...
**Languages:** Python | SQL | Java | JavaScript | HTML/CSS | TypeScript

**Frameworks & Libraries:** Node.js | Next.js | Express.js | Flask | OpenCV | MediaPipe | Tkinter

**Databases:** MongoDB | MySQL

**Tools & Platforms:** Git | GitHub | Vercel | Render | VS Code | Burp Suite | Nmap | Nikto | Wireshark

**Domains:** Web Development | Cybersecurity | AI/ML | Cloud Computing
...
| [♻️ Smart Waste](https://github.com/arathism/SmartWaste_ComplaintSystem) | Civic waste complaint portal with admin dashboard | MERN Stack | — |
| [🔐 Secure Login](https://github.com/arathism/SecureLoginProject) | GUI login system with brute-force detection | Python, Tkinter | — |
...
- 📧 **Email:** [smarathism@gmail.com](mailto:smarathism@gmail.com)
